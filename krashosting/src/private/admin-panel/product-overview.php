...
<head>
    ...
    <script src="../api/scripts/product-scripts/product-management.js"></script>
...
<body> 
    ...
    <div class="main">
        ...
        <div class="content-container">
            <div class="content-title">Product overview</div>
            <div class="content-subtitle">Snelle overview van alle producten</div>
